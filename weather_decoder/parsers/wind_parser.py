...
class WindParser:
    ...
    def extract_wind(parts: List[str]) -> Optional[Dict]:
        ...
        for i, part in enumerate(parts):
            ...
            if match:
                ...
                wind = {"direction": direction, "speed": speed, "unit": unit}
    ...
    def parse_wind_string(wind_str: str) -> Optional[Dict]:
        ...
        if extreme_match:
            ...
            return {"direction": "VRB", "speed": speed, "unit": unit, "above": True}
        ...
        wind = {"direction": "VRB" if direction_str == "VRB" else int(direction_str), "speed": speed, "unit": unit}
